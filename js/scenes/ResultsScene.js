var ResultsScene = class extends Phaser.Scene {
    ...
    create() {
        ...
        this.add.text(panelX + 16, row, '🪙 Coins x' + CONSTANTS.COIN_VALUE, lblStyle);
        this.add.text(panelX + panelW - 16, row, this._coins + ' coin = +' + (this._coins * CONSTANTS.COIN_VALUE), valStyle).setOrigin(1, 0);
        row += gap;
